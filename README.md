...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-8">
        ...
        <p>Welcome to Pharmeasy,our mission is to provide safe, effective, and accessible healthcare solutions to patients worldwide.</p>
        <p>At PharmaEasy, With a relentless focus on innovation and quality, we are at the forefront of cutting-edge medical advancements, ensuring that every product we create is a testament to our unwavering commitment to excellence.</p>
        <p>In addition to medications,PharmaEasy are pivotal in creating and distributing drugs, vaccines, and medical devices to enhance human health. </p>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 Pharmeasy. All rights reserved. RAHUL VIJAY V (212223040164)</p>
  </footer>
...
<body>
      ...
      <div class="col-md-12">
        ...
        <div id="values">
          ...
          <ul>
            ...
            <li>Customer-oriented: Being a customer-oriented PharmaEasy, the prospect is to digitalize the business by serving quality pharma products online.</li>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-3">
    <p>&copy; 2024 PharmEasy. All rights reserved.  BY Rahul vijay V (212223040164)</p>
  </footer>
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="Over-the-Counter-drugs.png" class="card-img-top" alt="Product 1" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="prescreptiondruds.jpg" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Contact Us - PharmEasy</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-2 ">
    <p>&copy; 2024 PharmaEasy. All rights reserved. BY AMALJOSH MAADHAV J (212223230012)</p>
...
## OUTPUT:
![alt text](<Screenshot 2024-05-12 231518.png>)
![alt text](<Screenshot 2024-05-12 231530-1.png>)
![alt text](<Screenshot 2024-05-12 231542.png>)
